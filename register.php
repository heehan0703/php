<? ob_start();if(basename($_SERVER['REQUEST_URI'])==='register.php'){header("location:https://ebhahair.com/register.html",  true,  301 );exit;}ob_flush();?>
<?
 session_start();
...
<!--body start-->
<div class="full" id="body_container" style="background-image:url('images/strip.png'); overflow:hidden;">
  <div class="container">
   ...
   <div class=" text-left text-uppercase" style="margin-top:0; margin-right:1%; margin-bottom:0; margin-left:1%;">
   ...
   <hr> </div>
	 ...
	 <form name="register" action="register_process.php"  method="post" onSubmit="return Validate()">
        <div class="col-lg-8 col-sm-12 col-xs-12 border-bottom-small text-right-small" style="border-right-width:1px; border-right-color:rgb(238,238,238); border-right-style:solid;">
       <div class="full" style="margin-top:0em; margin-right:0em; margin-bottom:2em; margin-left:3%; overflow:hidden;">
    <span style="color:#999999; font-weight:bold;">Create Your Account</span> &nbsp;
    <span class="dotted-class" style="width:65%;"></span>
    </div>   
      
         <div class="full" style="overflow:hidden; margin:.7em 0;">
	...
	<?php } ?>
      ...
      <script type="text/javascript">
		...
		$("#state_div").hide('fast');		
           ...
           <div class="full" id="state_div" style="overflow:hidden; margin:.7em 0;">
...
<?=$state_row['state_name']?></option>	 
 <? } ?>
    ...
    <div class="full" style="margin-top:3em; margin-right:0em; margin-bottom:2em; margin-left:3%; overflow:hidden;">
    ...
    <span class="dotted-class" style="width:65%;"></span>
       ...
       <input type="text" name="com_name" id="com_name" class="form-control" style="width:80%; float:left;border-radius: 3px 0px 0px 3px;" >
          ...
          <div class="col-lg-8 col-sm-12 col-xs-12">
            <div  class="row">
                  <div class="col-lg-12 col-sm-12 col-xs-12"><input type="text" name="tel1" id="tel1" class="input-xm" style="width:45px; display:inline; border:1px solid gray">-<input type="text" name="tel2" id="tel2" class="input-xm" style="width:45px; display:inline;border:1px solid gray">-<input type="text" name="tel3" id="tel3" class="input-group-sm"  style="width:100px;margin-left:0px; display:inline;border:1px solid gray"></div>
          ...
          <div class="col-lg-12 col-sm-12 col-xs-12">
                   <input type="text" name="cel1" id="cel1" class="input-xm" style="width:45px; display:inline;border:1px solid gray">-<input type="text" name="cel2" id="cel2" class="input-xm"  style="width:45px; display:inline;border:1px solid gray">-<input type="text" name="cel3" id="cel3" class="input-group-sm" style="width:100px;margin-left:0px; display:inline;border:1px solid gray">              </div>
           </div>      
          </div>
          </div>  
    ...
    <span class="glyphicon glyphicon-repeat" onClick="document.getElementById('captcha').src='captcha.php?'+Math.random();" style="cursor:pointer;"></span>      
       ...
       <input  type="checkbox" name="bhha" id="bhha"  style=""> <span><font style="color:#000000; font-size:14px"> Become a <font color="green"><b>EBHA LOYALTY REWARD PROGRAM 15% Commission for your Referral</b></font>:</font><font style="color:#FF0000; font-size:14px">No need license</font></span>
          </div>
          </div>
          
          
          
      <div class="full text-center" style="overflow:hidden;">
        <div class="col-lg-4 col-sm-12 col-xs-12 text-right"></div>
...
<!--right portion start-->    
                    <div class="col-lg-4 col-sm-12 col-xs-12">
                        <p><img src="images/loyalty_program.jpg" width="450" height="600" border="0"> 
<br>
Join Our loyalty Program:</p>
                        <p>Go to EBHAhair.com </p>     
  <p>1. Click and  [sign up] for our loyalty program.</p>
  <p>2. Fill in your information to create an account.</p>
  <p>3. After the account is created, you will receive your own  coupon code  ----[xxxxxx].</p>
  <p>4. Now you can tell your friends and family  to use your 15% off  coupon code.</p>
  <p>5.Everytime code is used  commission will go directly to your account.</p>
  <p>6. Sweet deal right? Hurry and sign up today.</p>
    ...
    <div class="full text-right" style="color:rgb(240,0,0); padding-right:1em; padding-bottom:16px; overflow:hidden;"><sup><img src="images/star_red.png"></sup>Required Filed</div>  
...
<div id="overlay-mask-3" class="overlay-mask" style="">
  <div class="overlay iframe-content" style="font-size:1.2em; border-width:5px; border-color:rgb(240,240,240); border-style:solid;">
...
<p>Welcome to ebhahair.com.  Wholesale Services LLC and/or its affiliates (&quot;ebhahair Wholesale&quot;) provide website features and other products and services to you when you visit or shop at ebhahair.com, use ebhahair Wholesale products or services, use ebhahair Wholesale applications for mobile, or use software provided by ebahhair Wholesale in connection with any of the foregoing (collectively, &quot; Wholesale Services&quot;).  Wholesale provides the  Wholesale Services subject to the following conditions.</p>
