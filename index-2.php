...
<html class="no-js" lang="">
    ...
    <body>
										...
										<li><a href="shop.html">Women</a>
											<div class="megamenu">
												...
												<div class="mega-bottom">
													<a href="#"><img src="shopic/img/megamenu/1.jpg" alt="#"></a>
												</div>
											</div>
										</li>
										...
										<div class="mini-cart-content">
											<div class="cart-img-details">
												<div class="cart-img-photo">
													<a href="#"><img src="shopic/img/cart/1.jpg" alt="#"></a>
												</div>
        ...
        <section class="slider-area style-2">
            <div class="bend niceties preview-2">
                <div id="ensign-nivoslider" class="slides"> 
					<img src="shopic/img/slider-2/slider-2-1.jpg" alt="" title="#slider-direction-1"  />
                    <img src="shopic/img/slider-1/slider-1-3.jpg" alt="" title="#slider-direction-2"  />
					<img src="shopic/img/slider-2/slider-2-1.jpg" alt="" title="#slider-direction-3"  />
                </div>
                <!-- direction 1 -->
        ...
        <section class="content style-2">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-4 col-sm-4">
							<div class="product-banner banner-4 banner-5">
								<a class="banner-photo" href="#"><img src="shopic/img/banner/4.jpg" alt="#" /></a>
						...
						<div class="col-md-4 col-sm-4">
							<div class="product-banner banner-2 banner-5">
								<a class="banner-photo" href="#"><img src="shopic/img/banner/5.jpg" alt="#" /></a>
								<div class="banner-brief">
									<p>look book</p>
									<h2>Realman</h2>
									<p>collection 2016</p>
						...
						<div class="col-md-4 col-sm-4">
							<div class="product-banner banner-2  banner-5">
								<a class="banner-photo" href="#"><img src="shopic/img/banner/6.jpg" alt="#" /></a>
								<div class="banner-brief">
						...
						<div class="active-product-carousel navigation-top">
							...
							<div class="col-md-12">
								<div class="single-product">
									<div class="product-img">
										...
										<a class="pro-image" href="#">
											<img class="primary-image" src="shopic/img/product/featured/9.jpg" alt="#">
											<img class="secondary-image" src="shopic/img/product/featured/11.jpg" alt="#">
										</a>
								...
								<div class="single-product">
									<div class="product-img">
										<a class="pro-image" href="#">
											<img class="primary-image" src="shopic/img/product/featured/6.jpg" alt="#">
											<img class="secondary-image" src="shopic/img/product/featured/9.jpg" alt="#">
										</a>
										<div class="pro-actions">
											<a class="action-btn" href="#" data-toggle="tooltip" data-original-title="Wishlist" data-placement="left"><i class="pe-7s-like"></i></a>
											<a class="action-btn" href="#" data-toggle="tooltip" data-original-title="Compare" data-placement="left"><i class="pe-7s-repeat"></i></a>
							...
							<div class="col-md-12">
								<div class="single-product">
									<div class="product-img">
										...
										<a class="pro-image" href="#">
											<img class="primary-image" src="shopic/img/product/featured/10.jpg" alt="#">
											<img class="secondary-image" src="shopic/img/product/featured/9.jpg" alt="#">
										</a>
										<div class="pro-actions">
											<a class="action-btn" href="#" data-toggle="tooltip" data-original-title="Wishlist" data-placement="left"><i class="pe-7s-like"></i></a>
								...
								<div class="single-product">
									<div class="product-img">
										<a class="pro-image" href="#">
											<img class="primary-image" src="shopic/img/product/featured/11.jpg" alt="#">
											<img class="secondary-image" src="shopic/img/product/featured/10.jpg" alt="#">
										</a>
										<div class="pro-actions">
											<a class="action-btn" href="#" data-toggle="tooltip" data-original-title="Wishlist" data-placement="left"><i class="pe-7s-like"></i></a>
											<a class="action-btn" href="#" data-toggle="tooltip" data-original-title="Compare" data-placement="left"><i class="pe-7s-repeat"></i></a>
							...
							<div class="col-md-12">
								<div class="single-product">
									<div class="product-img">
										...
										<a class="pro-image" href="#">
											<img class="primary-image" src="shopic/img/product/featured/3.jpg" alt="#">
											<img class="secondary-image" src="shopic/img/product/featured/1.jpg" alt="#">
										</a>
										<div class="pro-actions">
											<a class="action-btn" href="#" data-toggle="tooltip" data-original-title="Wishlist" data-placement="left"><i class="pe-7s-like"></i></a>
											<a class="action-btn" href="#" data-toggle="tooltip" data-original-title="Compare" data-placement="left"><i class="pe-7s-repeat"></i></a>
								...
								<div class="single-product">
									<div class="product-img">
										<a class="pro-image" href="#">
											<img class="primary-image" src="shopic/img/product/featured/2.jpg" alt="#">
											<img class="secondary-image" src="shopic/img/product/featured/1.jpg" alt="#">
										</a>
										<div class="pro-actions">
											<a class="action-btn" href="#" data-toggle="tooltip" data-original-title="Wishlist" data-placement="left"><i class="pe-7s-like"></i></a>
							...
							<div class="col-md-12">
								<div class="single-product">
									<div class="product-img">
										...
										<a class="pro-image" href="#">
											<img class="primary-image" src="shopic/img/product/featured/12.jpg" alt="#">
											<img class="secondary-image" src="shopic/img/product/featured/2.jpg" alt="#">
										</a>
										<div class="pro-actions">
											<a class="action-btn" href="#" data-toggle="tooltip" data-original-title="Wishlist" data-placement="left"><i class="pe-7s-like"></i></a>
											<a class="action-btn" href="#" data-toggle="tooltip" data-original-title="Compare" data-placement="left"><i class="pe-7s-repeat"></i></a>
								...
								<div class="single-product">
									<div class="product-img">
										...
										<a class="pro-image" href="#">
											<img class="primary-image" src="shopic/img/product/featured/4.jpg" alt="#">
											<img class="secondary-image" src="shopic/img/product/featured/5.jpg" alt="#">
										</a>
										<div class="pro-actions">
											<a class="action-btn" href="#" data-toggle="tooltip" data-original-title="Wishlist" data-placement="left"><i class="pe-7s-like"></i></a>
											<a class="action-btn" href="#" data-toggle="tooltip" data-original-title="Compare" data-placement="left"><i class="pe-7s-repeat"></i></a>
			...
			<!-- UP-COMMING-PORDUCT-ACER START -->
			<div class="upcomming-product-area fix">
				<div class="col-md-6 col-sm-6 col-xs-12 upcomming-product">
					<img src="shopic/img/product/upcomming/1.jpg" alt="" />
					<div class="upcomming-about">
						<h2>exclusive men's <br> collection <br> 2016- </h2>
						<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</p>
						<a class="shop-now" href="#">shop now <i class="pe-7s-angle-right"></i></a>
					</div>
				</div>
				<div class="col-md-6 col-sm-6 col-xs-12 upcomming-product upcomming-product-2">
					<img src="shopic/img/product/upcomming/2.jpg" alt="" />
					<div class="upcomming-about">
						<h2>exclusive women's <br> collection <br> 2016- </h2>
						<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</p>
						<a class="shop-now" href="#">shop now <i class="pe-7s-angle-right"></i></a>
					</div>
				</div>
						...
						<div class="row">
							<div class="col-md-2 hidden-sm hidden-xs">
								<div class="product-banner banner-3 single-product">
									<a class="banner-photo" href="#"><img src="shopic/img/banner/3.jpg" alt="#" /></a>
											...
											<div class="col-sm-5 arrival-1">
												...
												<div class="single-product">
													<div class="product-img">
														...
														<a class="pro-image" href="#">
															<img class="primary-image" src="shopic/img/product/arrival/1-bg.jpg" alt="#">
															<img class="secondary-image" src="shopic/img/product/arrival/1.jpg" alt="#">
														</a>
													...
													<div class="col-sm-6">
														<div class="single-product">
															<div class="product-img">
																...
																<a class="pro-image" href="#">
																	<img class="primary-image" src="shopic/img/product/arrival/2.jpg" alt="#">
																	<img class="secondary-image" src="shopic/img/product/arrival/3.jpg" alt="#">
																</a>
																<div class="pro-actions">
																	<a class="action-btn action-btn-1" href="cart.html"><i class="pe-7s-cart"></i>Add to Cart</a>
																	<a class="action-btn" href="wishlist.html" data-toggle="tooltip" data-original-title="Add to Wishlist"><i class="pe-7s-like"></i></a>
														...
														<div class="single-product">
															<div class="product-img">
																<a class="pro-image" href="#">
																	<img class="primary-image" src="shopic/img/product/arrival/3.jpg" alt="#">
																	<img class="secondary-image" src="shopic/img/product/arrival/4.jpg" alt="#">
																</a>
																<div class="pro-actions">
																	<a class="action-btn action-btn-1" href="cart.html"><i class="pe-7s-cart"></i>Add to Cart</a>
																	<a class="action-btn" href="wishlist.html" data-toggle="tooltip" data-original-title="Add to Wishlist"><i class="pe-7s-like"></i></a>
													...
													<div class="col-sm-6">
														<div class="single-product">
															<div class="product-img">
																...
																<a class="pro-image" href="#">
																	<img class="primary-image" src="shopic/img/product/arrival/5.jpg" alt="#">
																	<img class="secondary-image" src="shopic/img/product/arrival/2.jpg" alt="#">
																</a>
																<div class="pro-actions">
																	<a class="action-btn action-btn-1" href="cart.html"><i class="pe-7s-cart"></i>Add to Cart</a>
																	<a class="action-btn" href="wishlist.html" data-toggle="tooltip" data-original-title="Add to Wishlist"><i class="pe-7s-like"></i></a>
														...
														<div class="single-product">
															<div class="product-img">
																<a class="pro-image" href="#">
																	<img class="primary-image" src="shopic/img/product/arrival/4.jpg" alt="#">
																	<img class="secondary-image" src="shopic/img/product/arrival/5.jpg" alt="#">
																</a>
																<div class="pro-actions">
																	<a class="action-btn action-btn-1" href="cart.html"><i class="pe-7s-cart"></i>Add to Cart</a>
																	<a class="action-btn" href="wishlist.html" data-toggle="tooltip" data-original-title="Add to Wishlist"><i class="pe-7s-like"></i></a>
							...
							<div class="active-testimonial-carousel navigation-bottom">
								<div class="col-md-12">
									<div class="single-testimonial">
										...
										<div class="author-photo">
											<img src="shopic/img/review/1.jpg" alt="" />
										</div>
								...
								<div class="col-md-12">
									<div class="single-testimonial">
										...
										<h3>Chairman</h3>
										<div class="author-photo">
											<img src="shopic/img/testimonial/1.jpg" alt="" />
										</div>
										<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting.</p>
									</div>
								</div>
						...
						<div class="active-blog-post  navigation-top">
								...
								<div class="blog-post-inner">
									<div class="post-thumbnail">
										<a href="single-blog.html">
											<img src="shopic/img/blog/1.jpg" alt="" />
							...
							<div class="col-md-12">
								<div class="blog-post-inner">
									<div class="post-thumbnail">
										<a href="single-blog.html">
											<img src="shopic/img/blog/2.jpg" alt="" />
											<span class="moretag"></span>
										</a>
										<div class="post-meta">
											<div class="single-meta date">
						...
						<div class="active-brands-logo">
							...
							<div class="col-md-12">
								<div class="single-brand-logo">
									<img src="shopic/img/brand/1.png" alt="" />
								</div>
							</div>
							...
							<div class="col-md-12">
								<div class="single-brand-logo">
									<img src="shopic/img/brand/2.png" alt="" />
								</div>
							</div>
							<!-- Single-Brand-Logo End -->
							<!-- Single-Brand-Logo Start -->
							<div class="col-md-12">
								<div class="single-brand-logo">
									<img src="shopic/img/brand/3.png" alt="" />
								</div>
							</div>
							<!-- Single-Brand-Logo End -->
							<!-- Single-Brand-Logo Start -->
							<div class="col-md-12">
								<div class="single-brand-logo">
									<img src="shopic/img/brand/4.png" alt="" />
								</div>
							</div>
							<!-- Single-Brand-Logo End -->
							<!-- Single-Brand-Logo Start -->
							<div class="col-md-12">
								<div class="single-brand-logo">
									<img src="shopic/img/brand/5.png" alt="" />
								</div>
							</div>
							<!-- Single-Brand-Logo End -->
							<!-- Single-Brand-Logo Start -->
							<div class="col-md-12">
								<div class="single-brand-logo">
									<img src="shopic/img/brand/6.png" alt="" />
								</div>
							</div>
							<!-- Single-Brand-Logo End -->
							<!-- Single-Brand-Logo Start -->
						...
						<div class="col-md-12">
							<div class="footer-top">
								<div class="footer-logo">
									<img src="shopic/img/logo.png" alt="" />
								</div>
						...
						<div class="col-lg-2  hidden-md hidden-sm">
							<div class="single-footer instagram">
								...
								<div class="instagram-thumb">
									<a href="#"><img src="shopic/img/instagram/1.jpg" alt="" /></a>
									<a href="#"><img src="shopic/img/instagram/2.jpg" alt="" /></a>
									<a href="#"><img src="shopic/img/instagram/3.jpg" alt="" /></a>
									<a href="#"><img src="shopic/img/instagram/4.jpg" alt="" /></a>
								</div>
							</div>
						</div>
						<div class="col-lg-3 col-md-4 col-sm-4">
							...
							<div class="modal-product">
								<div class="product-images">
									<div class="main-image images">
										<img alt="#" src="shopic/img/product/quickview-photo.jpg"/>
									</div>
								</div><!-- .product-images -->
