...
function XML_Array(&$data,$ignore = Array(),$replace = Array(),$showattribs = false,$toupper = false)
{
...
else if ($value ==    "UPSSAVER")
 {
 $this->service_code = "65";
 }
 else if ($value ==    "UPSEXPEDITED")
 {
 $this->service_code = "08";
 }
