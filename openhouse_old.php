...
$page_detail=mysql_fetch_assoc(mysql_query("SELECT * FROM `page_details` where page_name='openhouse' "));
...
<div class="full" id="body_container">
  <div class="container">
    ...
    <div class="row" style="padding:1em;"> <span class="glyphicon glyphicon-home"></span>&nbsp;OPEN HOUSE</div>
    <hr>
...
<div align="center">
              <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:#df5757;">
                <tr>
                  <td height="44" align="center" bgcolor="#EAD8C4" class="height35"><a href="openhouse.php"><img src="images/ebha_1_1.jpg" alt="ebha" width="640" height="183" border="0"></a></td>
                </tr></table><div>


			        <div><table border="0" cellpadding="0" cellspacing="0" align="center">
			          <tr>
			            <td align="center" style="color:#8d8b89;font-family: 'Lato', sans-serif;font-size:14px;line-height:23px;">Taking back our black Hair Industry<br />
			              Commuity Open House</td>
		              </tr>
			          </table></td>
		          </tr>
			      <tr>
			        <td class="height25" height="47"></td>
		          </tr>
			      <tr>
			        <td align="center"><table border="0" cellpadding="0" cellspacing="0" style="border-radius:27px; background-color:#df5757;">
			          <tr>
			            <td align="center" width="275" height="55"><a href="#" style="font-family: 'Lato', sans-serif;font-size:18px;font-weight:700;line-height: 55px;text-decoration: none; color:#fff;display:block;">GIVEAWAYS!</a></td>
		              </tr>
			          </table></td>
		          </tr>
			      <tr>
			        <td class="height35" height="80"><img src="images/ebha_2.jpg" alt="2" width="640" height="594"></td>
		          </tr>
		        </table></div>
<div align="center">
              <table border="0" cellpadding="0" cellspacing="0" width="100%" >
                <tr>
                  <td height="44" align="center" class="height35"><img src="images/ebha_4.jpg" alt="ebha" border="0"></a></td>
                </tr></table><div>

			    
<div class="container">
			            <div style="color:#df5757;font-family: 'Montserrat', sans-serif;font-weight:700;font-size:18px;">EBHA Hair Line Demonstrastion</div>
		                        <div style="color:#969696; line-height:22px;font-size:14px;font-family: 'Lato', sans-serif;">
                                                                            <p>EBHA supplying a wide range of quality hair products; Remy Hair Extensions, <br>
Synthetic Wigs, Human hair Wigs, Half-Wigs, Draw-String Ponytails, <br>Human Hair Extensions, Synthetic Extensions, Remy Hair, Lace Wigs, Accessories, etc. <br>
We are focused on creating the most innovative hair products with quick easy hairstyles featuring our &quot;SHUN FA&quot; series, <br>which is the top brand
in the market, and has never been left behind in this fierce competition of the industry. <br>EBHA is currently in the process of launching several new lines of highly distinguished products under brand names that include:<br />
</p>
                                                                            <p>			                          SHANICHE'E CHINESE UNPROCESSED VIRGIN HUMAN HAIR WEAVES,<br />
			                          DE'JA BRAZILIAN HUMAN HAIR WEAVES,<br />
			                          EVOTWIN WIGS, HUMAN WIGS,<br />
			                          AH-FRESH BRAIDS<br />
			                          </p>
                                                                            <p>What distinguishes our products from our competitors is: <br>
Quality. Made with 100% real human hair, the quality of our products are far superior to any other products available in the market. <br>
This is accomplished by using the finest 100% human hair in our human hair products and heat- friendly high fiber in our synthetic products.<br> 
We are very proud to present our products to you! EBHA. is dedicated to your satisfaction and promises<br>
to keep on supplying the highest quality
products in the market.</p>
                                                               </div>
		<div></div>
<div class="container">
      <div style="color:#df5757;font-family: 'Montserrat', sans-serif;font-weight:700;font-size:18px;">Thank you</div>

 



<img src="https://ebhahair.com/images/SAM.jpg"><br>Mr. Sam Ennon, founder and president of BOBSA and CEO of EBHA<br>
<br></div>
		            
              <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:#EAD8C4;">
                <tr>
                  <td height="44" align="center" class="height35"><img src="images/ebha_3.jpg" alt="ebha" border="0"></a></td>
                </tr></table><div>
		  
<div><table  width="100%" style="background-color:#df5757;">
                <tr>
                  <td align="center" style="color:#fff;font-size:12px;font-family: 'Lato', sans-serif;">Join us now!! <a href="openhouse.php">more info</a></td>
                </tr>
                <tr>
                  <td height="16"></td>
                </tr>
                <tr>
                  <td align="center" style="color:#fff;font-family: 'Montserrat', sans-serif;"><h2>SUNDAY, March 19</h2></td>
                </tr>
                <tr>
                  <td height="20"></td>
                </tr>
                <tr>
                  <td align="center"><table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="336" align="center" style="color:#fff;line-height: 24px;font-family: 'Montserrat', sans-serif;"><h4>Sunday <strong>March 19, 2017 From 1:00 PM to 6:00 PM</strong><br />
                        EBHA/BOBSA I <a href="https://www.google.com/maps/place/1951+Landmeier+Rd,+Elk+Grove+Village,+IL+60007/@42.0102107,-87.9559049,17z/data=!3m1!4b1!4m5!3m4!1s0x880fb117f751cd45:0xf3874c91a99f0b78!8m2!3d42.0102067!4d-87.9537162">1951 Landmeier Rd Elk Grove Village, IL 60007</a></h4></td>
                    </tr>
                  </table></td>
                </tr>
              </table>
            <a href="openhouse.php"></a></div>
  ...
  <span class="" style="font-family:sans-serif;">Cancel</span>
   ...
   <div style="border:0px solid #97cf00; padding:1em;" class="content"> 
    ...
    <div class="col-lg-12 col-xs-12 col-xs-12 text-center">
      <strong> <a href="https://ebhahair.com/wholesale_register.php" target="_blank">NEW MEMBER REGISTER</a></strong>
      </div>
      </div>
      </div>
