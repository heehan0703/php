...
$page_detail=mysql_fetch_assoc(mysql_query("SELECT * FROM `page_details` where page_name='Shipping Policy' "));
...
<div class="full" id="body_container">
  <div class="container">
    ...
    <div class="row" style="padding:1em;"> <span class="glyphicon glyphicon-home"></span>&nbsp;How to order</div>
    <hr>
