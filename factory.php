...
$page_detail=mysql_fetch_assoc(mysql_query("SELECT * FROM `page_details` where page_name='factory' "));
...
<title>Facoty Pictures Enterprise of Black Hair Alliance </title>
...
<div class="full" id="body_container">
  <div class="container">
    ...
    <div class="row" style="padding:1em;"> <span class="glyphicon glyphicon-home"></span>&nbsp;FACTORY </div>
    <hr>
