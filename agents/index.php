			...
			<div class="slider-area margin-bottom-80">
				<div class="bend niceties preview-2">
					<div id="ensign-nivoslider" class="slides">	
					     <img src="images/fa_hair_title4.jpg" alt="" title="#slider-direction-1"  />
						<img src="images/fa_hair_title1.jpg" alt="" title="#slider-direction-2"  />
							...
							<div class="title-container s-tb-c title-compress">
								<div class="slider-1">
									...
									<div class="image wow fadeInUpBig" data-wow-duration="1.5s" data-wow-delay="0.7s">
										<span><a href="http://ebhahair.com/"><img src="shopick/img/slider/slider-1/slider-border.png" alt="" border="0" /></a></span>
									</div>
									...
									<div class="wow fadeInUpBig" data-wow-duration="2s" data-wow-delay="1.1s">
										<a href="https://ebhahair.com/weaves/" class="shop-now">shop now</a>
									</div>
								</div>
							</div>
						</div>	
...
Receive management and technical Support.</font></p><BR>
									...
									<div class="wow fadeInUpBig" data-wow-duration="2s" data-wow-delay="1.1s">
										<a href="https://ebhahair.com/dealer.html" class="shop-now"><font color="#FFFFFF">Become A Boss</font></a>
									</div>
								</div>
							</div>
						</div>		
						...
						<div class="slider-content t-lfl s-tb">
							<div class="title-container s-tb-c title-compress">
								<div class="slider-1">
									...
									<div class="image wow fadeInUpBig" data-wow-duration="1.5s" data-wow-delay="0.7s">
										<span><a href="http://ebhahair.com/wigs/"><img src="shopick/img/slider/slider-1/slider-border.png" alt="" border="0" /></a></span>
									</div>
									<div class="wow fadeInUpBig" data-wow-duration="1.8s" data-wow-delay="0.9s">
										<p class="slider-brief">100% Human Hair Product.</p>
									</div>
									<div class="wow fadeInUpBig" data-wow-duration="2s" data-wow-delay="1.1s">
										<a href="http://ebhahair.com/wigs/" class="shop-now">shop now</a>
									</div>
								</div>
							</div>
						</div>		
							...
							<div class="banner-style-2">
								<div class="single-banner-style-2 banner-brief-1">
									<div class="left-banner-img">
										<img class="" src="images/BECOMEABOSS.jpg" alt="" />
									</div>
									<div class="left-banner-brief">
										<h3>Boss Life</h3>
										<h4>ISR(Independant Sales Rep)</h4>
										<h4></h4>
										<p>Work when and where you want and you earn more!</p>
										<a href="https://ebhahair.com/wholesale_register.php" class="shop-now">Sign up</a>
								<a href="https://ebhahair.com/loan.php" class="shop-now">Quick Financing</a>
									</div>
								</div>
								<div class="single-banner-style-2 banner-brief-2">
									<div class="right-banner-brief">
										<h3>exclusive Bobsa</h3>
										<h4><img src="images/EBHA_BOBSA-01.png" width="184" height="104" border="0"></h4>
										<h4></h4>
										<p>Connecting the Black Dots! within the black community.</p>
										<a href="aboutus.php" class="shop-now">More</a>
									</div>
									<div class="right-banner-img">
										<img class="" src="images/EBHA_PRODUCT_BANNER.jpg" alt="" />
									</div>
								</div>
							</div>
						</div>
											...
											<div class="col-md-12">
												...
												<div class="single-product">
													...
													<div class="product-brief">
														<h2><a href="#"><?=html_entity_decode($new_arrival1['product_name']);?></a></h2>
...
How? Working closely with public high schools and community colleges in selected areas in the united states, EBHA would serve as boot camps in the public education arenas. </font>
          ...
          <div class="col-lg-12 col-md-12 col-sm-12" style="margin:0px; padding:0px; alignment-adjust:central">
			...
			<div class="new-collection-area fix margin-bottom-80">
				...
				<div class="col-lg-4 col-md-6 col-sm-6 padding-0">
					<div class="single-collection">
						<div class="collection-photo">
							<a href="http://ebhahair.com/wigs/"><img src="images/EBHA_EVOTWIN.jpg" alt="" border="0" /></a>
						</div>
						<div class="collection-brief">
						  ...
						  <a href="http://ebhahair.com/wigs/" class="shop-now active-shop-now">shop now</a>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 col-sm-6 padding-0">
					<div class="single-collection">
						<div class="collection-photo">
							<a href="https://ebhahair.com/weaves/"><img src="images/EBHA_DEJA.jpg" alt="" border="0" /></a>
						</div>
					  <div class="collection-brief">
						  ...
						  <a href="https://ebhahair.com/weaves/" class="shop-now active-shop-now">shop now</a>
						</div>
					</div>
				</div>
				<div class="col-lg-4 hidden-md hidden-sm padding-0 ">
					<div class="single-collection">
						<div class="collection-photo">
							<a href="http://ebhahair.com/braids/"><img src="images/EBHA_BRAID.jpg" alt="" border="0" /></a>
						</div>
					  <div class="collection-brief">
							<!--<div class="text-right">
  ...
  <li>HIGH-FIBER SYNTHETIC WIGS</li>
						  ...
						  <a href="http://ebhahair.com/braids/" class="shop-now active-shop-now">shop now</a>
						</div>
					</div>
				</div>
		  </div>
  ...
  <span class="" style="font-family:sans-serif;">Cancel</span>
   ...
   <div style="border:0px solid #97cf00; padding:1em;" class="content"> 
    ...
    <div class="col-lg-12 col-xs-12 col-xs-12 text-center">
      <strong> <a href="http://ebhahair.com/wholesale_register.php" target="_blank">Wholesaler Register</a></strong>
      </div>
      </div>
      </div>
