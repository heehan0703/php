...
//echo "$total_P";
 if($_SESSION['buyer_type']=="EBHA Member"){ 
$discount=$total_P*0.15;
$discount=number_format($discount,2);
$total_P=$total_P-$discount;
}
    ...
    <div id="datatable" style="width:100%">
      ...
      <!-- Checkout-Billing-details and order start -->
					<div class="checkout-bill-order">
						<form action="checkout_process_new.php" method="post" name="placeorderformnew" id="placeorderformnew" >
							<div class="row" >
								<div class="col-md-6" >
									<div class="checkout-bill">
										<div style="float:left; width:50%"><h3 class="title-7 margin-bottom-50">Billing Details</h3></div>
                                       
                            <div  style=" float:left; margin-top:15px;   <? if(!$buyerid) { ?> display:block; <? }else{ ?>display:none <? } ?>"> 
   ...
   $producturl1=strtolower(rtrim($producturl1, "-"));
												  ...
												  ?>
													<tr>
														...
														<?=number_format((float)$cart_goods_row['cnt']*$price1, 2, '.', '')?></td>
													</tr>
                                                    <? } ?>
                                                    
													
										<tr class="shipping" <? if($buyerid) { ?>  <? }else{ ?> style="display:none;" <? } ?> id="shipp" >
 ...
 onclick="update_rate(<?=$draw_free?>,'Priority Mail Express 1-Day')"  checked="checked" >
   ...
   onclick="update_rate(<?=$usps_international_all['26']['POSTAGE']?>,'Priority Mail Express International')" 
    value="<?=$usps_international_all['1']['POSTAGE']?>">
                                                    ...
                                                    <?  if($_SESSION['level']!=2){ ?>
                                            <tr class="shipping" <? if($buyerid) { ?>  <? }else{ ?> style="display:none;" <? } ?> id="pickup" >
							...
							<div class="payment-method" <? if($buyerid) { ?> style="display:block;"  <? }else{ ?> style="display:none;" <? } ?> id="paymentpart" >
...
<!-- endbuild -->
 ...
 <!-- all js here -->
        ...
        <script src="../shopick/js/vendor/jquery-1.12.0.min.js"></script>
		<!-- bootstrap js -->
        <script src="../shopick/js/bootstrap.min.js"></script>
		<!-- jquery.nivo.slider js -->
        <script src="../shopick/lib/js/jquery.nivo.slider.js"></script>
        <script src="../shopick/lib/home.js"></script>
		<!-- owl.carousel js -->
        <script src="../shopick/js/owl.carousel.min.js"></script>
		<!-- meanmenu js -->
        <script src="../shopick/js/jquery.meanmenu.js"></script>
		<!-- jquery-ui js -->
        <script src="../shopick/js/jquery-ui.min.js"></script>
		<!-- lightbox.min js -->
        <script src="../shopick/js/lightbox.min.js"></script>
		<!-- countdon.min js -->
        <script src="../shopick/js/countdon.min.js"></script>
		<!-- wow js -->
        <script src="../shopick/js/wow.min.js"></script>
		<script type="text/javascript">
			new WOW().init();
		</script>
		<!-- plugins js -->
        <script src="../shopick/js/plugins.js"></script>
		<!-- main js -->
        <script src="../shopick/js/main.js"></script>
			 ...
			 var cvv=document.getElementById('cvv').value;
			             if(card_number==''){
							...
							return false;
							 ...
							 document.getElementById("placeorderformnew").submit();
							//alert("shashi");
							//$("#placeorderformnew" )[0].submit();  
							//document.placeorderformnew.submit();
