...
$notice=mysql_fetch_array(mysql_query("SELECT * FROM admin_notice  order by id desc"));
...
<!-- ############ PAGE START-->
 <div class="row-col"><B><font color="#FF0000" size="+1">NOTICE: <?=date("m/d/Y",$notice['notice_date'])?>:<?=$notice['Notice']?> </font></B></div>
<div class="row-col">
