...
//alert("dhirendra");
	...
	Obj.submit();
      ...
      <table class="table  " style="width:100%; padding:0px; margin:0px; table-layout:fixed"  width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <td style="width:10%;padding:0px; margin:0px;" ><span class="projecthead"><b>CATEGORY</b></span></td>
                    <? if($_SESSION['buyer_type']=="Wholesaler"){ ?> <td  style="width:10%;padding:0px; margin:0px;" ><span class="projecthead" ><b>WHOLESALE PRICE</b></span></td> <? } ?>
                        <td style="width:10%;padding:0px; margin:0px;" ><span class="projecthead" ><b>SALON PRICE</b></span></td>
  ...
  $product_img=$productrow['images'];	
            ...
            <td style="width:15%;padding:0px; margin:0px; padding-left:4px;"><span class="projecthead"><?=$productrow['category']?></span></td>
                      <? if($_SESSION['buyer_type']=="Wholesaler"){ ?>    <td  style="width:10%;padding:0px; margin:0px;" ><span class="projecthead">$<? $wholesaleprice= number_format((float)$productrow['wholesale_price'], 2, '.', '');  ?><?=$wholesaleprice?></span></td> <? }?>
                        <td  style="width:10%;padding:0px; margin:0px;" ><span class="projecthead">$
					<? 	$salonprice= number_format((float)$productrow['msrp_price'], 2, '.', '');  ?>
