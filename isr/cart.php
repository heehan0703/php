    ...
    <div id="datatable" style=""  class="table-content table-responsive">
      <table class="table table-striped white b-a" style=" width:100%; padding:0px; margin:0px;"  cellpadding="0" cellspacing="">
            ...
            <? if($_SESSION['buyer_type']=="Wholesaler"){ ?>
                 <td style="width:10%;text-align:center" ><span class="projecthead"><b>PRICE</b></span></td>
            <? }else{ ?>
                 <td style="width:10%;text-align:center" ><span class="projecthead"><b>SALON PRICE</b></span></td>
            <? } ?>
