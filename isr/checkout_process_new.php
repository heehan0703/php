...
//echo "dhirendra--$ISR--$GOOD_SHOP_USERID";
...
'$ship_city','$ship_state','$ship_country','$ship_zipcode','$total_weight','$shipping_charge_other_countery','$service_choose','$addinfo','$billphone','$shipphone','$address2','$ship_address2','$discountval','$storepickup','$type','$ISR')");
