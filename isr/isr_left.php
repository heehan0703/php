      ...
      <div>
           <nav class="scroll nav-stacked nav-stacked-rounded nav-color">
            ...
            <ul class="navside" data-ui-nav>
              ...
              <li>
                <a href="buyer-list.php" class="b-info">
                  <span class="nav-icon text-white no-fade">
                    <i class="fa-user"></i>
                  </span>
                  <span class="nav-text">BUYER</span>
                           ...
                           <li>
                <a href="add-buyer.php" class="b-default">
                  <span class="nav-icon">
                    <i class="ion-person"></i>
                  </span>
                  <span class="nav-text">ADD BUYER</span>
                </a>
              </li>
			               <li>
      ...
      <div data-flex-no-shrink>
        <div class="nav-fold dropup">
          <a data-toggle="dropdown">
              <div class="pull-left">
                <div class="inline"><a href="http://ebhahair.com/isr/inventory.php"><span class="avatar w-40 grey">ISR</span></a></div>
