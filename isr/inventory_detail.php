...
$product_row=mysql_fetch_array($product);
 ...
 $color_option = $product_row['color'];
	...
	$wholesaleprice2=explode(",",$product_row['wholesaleprice2']);
	...
	Obj.submit();
      ...
      <table class="table table-striped white b-a" width="1664">
            ...
            <td style="width:120px;padding:0px; margin:0px; text-align:center;" width="250"><span class="projecthead"><b>CATEGORY</b></span></td>
                       <? if($_SESSION['buyer_type']=="Wholesaler"){ ?>  <th width="190" style="width:140px;padding:0px; margin:0px; text-align:center;"><span class="projecthead"><b>WHOLESALE PRICE</b></span></td> <? } ?>
                        <th width="164" style="width:140px;padding:0px; margin:0px; text-align:center;"><span class="projecthead"><b>SALON PRICE</b></span></td>
       ...
       <form method="post" action="cart.php" name="cartForm1" >
            ...
            <td width="250" style="padding:0px; margin:0px; text-align:center;"><span class="projecthead"><?=$product_row['category']?></td>
                       <? if($_SESSION['buyer_type']=="Wholesaler"){ ?>  <td width="190" style="padding:0px; margin:0px; text-align:center;"><span class="projecthead">$<?=number_format((float)$product_row['wholesale_price'], 2, '.', '')?></span></td> <? } ?>
                        <td width="164" style="padding:0px; margin:0px; text-align:center;"><span class="projecthead">$<?=number_format((float)$product_row['msrp_price'], 2, '.', '')?></span></td>
	...
	<div class="">
      <table class="table" style="width:100%; padding:0px; margin:0px; table-layout:fixed"  width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <td style="padding:0px; margin:0px; text-align:center;" width="10%"><span class="projecthead"><b>COLOR</b></span></td>
                     <? if($_SESSION['buyer_type']=="Wholesaler"){ ?>    <th width="10%" style="padding:0px; margin:0px; text-align:center;"><span class="projecthead"><b>WHOLESALE PRICE</b></span></td> <? } ?>
                        <th width="10%" style="padding:0px; margin:0px; text-align:center;"><span class="projecthead"><b>SALON PRICE</b></span></td>
        ...
        <form method="post" action="cart.php" name="cartFormdetail" >
		   ...
		   for($i=0;$i<$length_option_count;$i++) { $cart_cnt++; ?>
            ...
            <td width="10%" style="padding:0px; margin:0px; text-align:center;"><span class="projecthead"><?=$color_option[$i]?></span></td>
                       <? if($_SESSION['buyer_type']=="Wholesaler"){ ?>  <td width="10%" style="padding:0px; margin:0px; text-align:center;"><span class="projecthead">$ <?=number_format((float)$wholesaleprice2[$i], 2, '.', '')?></span></td> <? } ?>
