...
<html class="no-js" lang="">
    <head>
        ...
        <link rel="stylesheet" href="https://fahair.com/shopick/css/bootstrap.min.css">
		<!-- animate css -->
        <link rel="stylesheet" href="https://fahair.com/shopick/css/animate.css">
		<!-- jquery-ui.min css -->
        <link rel="stylesheet" href="https://fahair.com/shopick/css/jquery-ui.min.css">
		<!-- meanmenu css -->
        <link rel="stylesheet" href="https://fahair.com/shopick/css/meanmenu.min.css">
		<!-- nivo-slider css -->
        <link rel="stylesheet" href="https://fahair.com/shopick/lib/css/nivo-slider.css">
		<!-- owl.carousel css -->
        <link rel="stylesheet" href="https://fahair.com/shopick/css/owl.carousel.css">
		<!-- flaticon css -->
        <link rel="stylesheet" href="https://fahair.com/shopick/css/shopick-icon.css">
		<!-- pe-icon-7-stroke css -->
        <link rel="stylesheet" href="https://fahair.com/shopick/css/pe-icon-7-stroke.css">
		<!-- lightbox css -->
        <link rel="stylesheet" href="https://fahair.com/shopick/css/lightbox.min.css">
		<!-- style css -->
		<link rel="stylesheet" href="shopick/fstyle.css">
		<!-- responsive css -->
        <link rel="stylesheet" href="https://fahair.com/shopick/css/responsive.css">
		<!-- modernizr css -->
        <script src="https://fahair.com/shopick/js/vendor/modernizr-2.8.3.min.js"></script>
    </head>
    <body>
        <!--[if lt IE 8]>
		...
		<section class="page-content">
			...
			<div class="new-collection-area fix margin-bottom-80">
				...
				<div class="col-lg-4 col-md-6 col-sm-6 padding-0">
					<div class="single-collection">
						<div class="collection-photo">
							<a href="#"><img src="img/new-collection/1.jpg" alt="" /></a>
						</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-6 padding-0">
					<div class="single-collection">
						<div class="collection-photo">
							<a href="#"><img src="img/new-collection/2.jpg" alt="" /></a>
						</div>
						<div class="collection-brief">
							<div class="text-right">
								<span class="new">new</span>
				...
				<div class="col-lg-4 hidden-md hidden-sm padding-0 ">
					<div class="single-collection">
						<div class="collection-photo">
							<a href="#"><img src="img/new-collection/3.jpg" alt="" /></a>
						</div>
						<div class="collection-brief">
							<div class="text-right">
								<span class="new">new</span>
				...
				<div class="container">
					<div class="row cus-row-1">
						<div class="single-featured single-featured-1 featured-link">
							<a href="#"><img src="img/featured/1.jpg" alt="" /></a>
						...
						<div class="single-featured single-featured-2">
							<div class="single-featured-inner featured-link">
								<a href="#"><img src="img/featured/2.jpg" alt="" /></a>
								<div class="featured-brief">
									<a href="#"><i class="sp-arrow-long-right"></i></a>
								</div>
							</div>
							<div class="single-featured-inner featured-link">
								<a href="#"><img src="img/featured/3.jpg" alt="" /></a>
								<div class="featured-brief">
									<a href="#"><i class="sp-arrow-long-right"></i></a>
								</div>
							</div>
						...
						<div class="single-featured single-featured-1 featured-link">
							<a href="#"><img src="img/featured/4.jpg" alt="" /></a>
							<div class="featured-brief">
								<a href="#"><i class="sp-arrow-long-right"></i></a>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="copyright-brief">
								<p>Copyright &copy; <a href="http://www.codecarnival.net/">Codecarnival</a> All right reserved</p>
							</div>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-12">
