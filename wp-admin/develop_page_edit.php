...
$id=$_GET['id'];
$page_row= mysql_fetch_assoc(mysql_query("SELECT * FROM `page_details` where page_id='$id' "));
...
header("location:login.php");	
	...
	if(isset($_POST['submit'])){
	 ...
	 mysql_query("UPDATE `page_details` SET   page_name= '$page_name',
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                     ...
                     <tr>
                     <td>Page Name</td>
                     <td><input type="text" name="page_name" id="page_name" value="<?=$page_row['page_name']?>" /></td>
                     </tr>
                     <tr>
                     <td colspan="2"> Page Description</td>
                     </tr>
                     <tr>
                     <td colspan="2"><textarea class="ckeditor" cols="80" id="description" name="description" rows="10"><?=$page_row['page_description']?></textarea>	</td>
                     </tr>
                     <tr>
