...
$result = mysql_query("SELECT member_id,CONCAT(f_name,' ',l_name) as fullname,email,DATE_FORMAT(registered_date,'%d/%m/%Y') AS niceDate ,i_am,status FROM `member` where supplier = 0 order by member_id asc ");
