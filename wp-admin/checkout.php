<?php
session_start();
$store=mysql_fetch_assoc(mysql_query("SELECT * FROM `Manage_Store` where id='$store_id'"));
...
//echo "$_SESSION[level]";
if($_SESSION['level']==0 && $total_P>35 && $ups_country=='US'){
$ship_price=0;
$draw_free=0;
$ship_over35=1;
}
...
<div class="col-lg-6 col-xs-6">
     ...
     <!-- shipping method start  -->
      ...
      <div class="full" id="shipping_price_container" >  
...
<div class="full" style="padding:.5em 0;"> 
 ...
 Free shipping w/$35 order </div>
  ...
  <? } ?>
   ...
   <div class="full" style="padding:.5em 0;">
  <div class="col-lg-9 col-sm-9 col-xs-9"><input type="radio" name="shipping_type" onClick="update_rate(<?=$usps_servicepost_charge?>,'Standard Post')" value="<?=$usps_servicepost_charge?>">Standard Post</div>
  <div class="col-lg-3">$<?=number_format($usps_servicepost_charge,2)?></div>
  </div>
  ...
  <div class="full" style="padding:.5em 0;">
  <div class="col-lg-9 col-sm-9 col-xs-9"><input type="radio" name="shipping_type"  onclick="update_rate(<?=$Alluspsprice_list['1']['RATE']?>,'Priority Mail 2-Day')" value="<?=$Alluspsprice_list['1']['RATE']?>">
  
  Priority Mail 2-Day</div>
  <div class="col-lg-3">$<?=number_format($Alluspsprice_list['1']['RATE'],2)?></div>
  </div>
  
  
   <div class="full" style="padding:.5em 0;">
  <div class="col-lg-9 col-sm-9 col-xs-9"><input type="radio" name="shipping_type" onClick="update_rate(00,'Hold Order')">
  
   Hold Order</div>
  <div class="col-lg-3">$0.00</div>
  </div>
   ...
   <div class="full" style="padding:.5em 0;">
  <div class="col-lg-9 col-sm-9 col-xs-9"><input type="radio" name="shipping_type" onClick="update_rate(<?=$ups_gnd?>,'UPS Ground')"  value="<?=$ups_gnd?>">
  
  UPS Ground</div>
  <div class="col-lg-3">$<?=number_format($ups_gnd,2)?></div>
  </div>
  
  
   <div class="full" style="padding:.5em 0;">
  <div class="col-lg-9 col-sm-9 col-xs-9"><input type="radio" name="shipping_type" onClick="update_rate(<?=$ups_three_day?>,'UPS Three-Day Select')"  value="<?=$ups_three_day?>"> 
  
  UPS Three-Day Select</div>
  <div class="col-lg-3">$<?=number_format($ups_three_day,2)?></div>
  </div>
  
  
   <div class="full" style="padding:.5em 0;">
  <div class="col-lg-9 col-sm-9 col-xs-9"><input type="radio" name="shipping_type"  onclick="update_rate(<?=$ups_2da?>,'UPS 2nd Day Air')"  value="<?=$ups_2da?>">
  
  UPS 2nd Day Air</div>
  <div class="col-lg-3">$<?=number_format($ups_2da,2)?></div>
  </div>
  <? } 
  if($ups_country!='US'){
  ?>
 ...
 <div class=" col-lg-9 col-sm-9 col-xs-9">Total Amount</div>
 <div class="col-lg-3 col-xs-3 col-sm-3">$<?=number_format($total_P,2)?></div>
 </div>
 <div class="full" style="padding:.5em 0;font-size:1.2em;">
 <div class=" col-lg-9 col-sm-9 col-xs-9">Ship Amount</div>
 <div class="col-lg-3 col-xs-3 col-sm-3">$<span class="tax_span"><?=number_format($ship_price,2)?></span></div>
 </div>
 <div class="full" style="padding:.5em 0;font-size:1.5em; font-weight:bold;">
 <div class=" col-lg-9 col-sm-9 col-xs-9">Pay Amount</div>
 ...
 <input type="text" size="3" name="card_month" placeholder="MM" style="border-radius:5px; border:1px solid #BDC3CB; height:40px;">
  &nbsp;<input type="text" name="card_year" size="3"placeholder="YYYY" style="border-radius:5px; border:1px solid #BDC3CB; height:40px; ">
 </div> 
 ...
 <input type="submit" name="submit" value="PAY NOW" style="text-align:center;" class="red-btn" >
 </div>
 </div> 
...
<input type="submit" name="submit" style="text-align:center; font-size:1.3em; background:#268BB9;"
 class="red-btn" value="PAY By Paypal" >
        ...
        <!-- right side start -->
        <div class="col-lg-3 small-margin-2">
