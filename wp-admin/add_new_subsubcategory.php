...
header("location:login.php");	
	...
	$catid=$_GET['catid'];
$subcatid=$_GET['sub_catid'];  
	   //echo   $cat_id;
	 if(isset($_POST['submit']))
	 {
		 $name=$_POST['Id'];
		 
		 $rec = "insert into sub_subcategory (cat_id,name,sub_cat_id) values ('$catid','$name','$subcatid')";
		 //echo "insert into subcategory (cat_id,name) values ($cat_id,'$name')";
		 $order= mysql_query($rec);
		
		 header("location:http://fahair.com/wp-admin/sub_sub_category.php?cat_id=$catid&sub_cat_id=$subcatid");	
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          ...
                          <td width="99%" class="blue-bx-topmid-bg" ><table width="100%" border="0" cellspacing="5" cellpadding="0">
                            ...
                            <tr>
                              ...
                              <td align="left" class="white-18">Add Sub Sub Category</td>
     ...
     <tr>
     <td width="30%" align="left" colspan="4">Sub Sub Category Name</td>
     <td width="40%" align="left" colspan="4">
     <input type="text" name="Id" id="Id" class="form-group"  ></td>
