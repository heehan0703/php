...
if(isset($_POST['submit'])){
	  ...
	  $sql = "INSERT INTO Pickup (store_id,pickup,price,no_days) VALUES ('$id','$pickup', '$price', '$no_days')";
...
<table align="center"> <tr>
    <th width="30%" align="left">Pickup</th>
    ...
    <th width="21%" align="left">Delivery Time</th>
                       ...
                       <table align="center">
                      <tr> <td valign="top">
  <input  type="text" name="pickup" maxlength="50" size="30" value="">
