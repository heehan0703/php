...
require_once('wp-admin/include/connectdb.php');
 ...
 $stmt=$con_pdo->prepare("insert into member set `f_name`=:f_name, `l_name`=:l_name, `email`=:email, `pwd`=:pwd, `address1`=:address1, `address2`=:address2, `city`=:city, `state`=:state, `country`=:country, `zipcode`=:zipcode, `i_am`=:i_am, `company_name`=:company_name, `tel`=:tel, `cel`=:cel, `registered_date`=:time ");
...
$stmt->bindParam(':state',$state='');	 
 ...
 $from = "silhouettehair <info@silhouettehair.com>";
 $to= "$email";
 //$to = "baislavimal@gmail.com";
 $subject ="[silhouettehair] Order confirmation";
 $body ="<!doctype html>
<html>
<head>
...
<div class=WordSection1>
 ...
 style='width:100.0%;mso-cellspacing:1.5pt;mso-yfti-tbllook:1184'>
  ...
  'Times New Roman''>&nbsp;
   ...
   1184'>
    ...
    </v:shape><![endif]--><![if !vml]><img src='http://beautco.com/e-mail/beautco_logo-01.jpg' width='187' height='67' border='0'><![endif]></span></a>
                  <o:p></o:p>
                  </span></p></td>
            </tr>
    ...
    mso-fareast-font-family:'Times New Roman';color:#555454;text-transform:
    uppercase'>Thank you for creating a customer account at silhouettehair.com wholesale.</span></span> <span style='mso-fareast-font-family:
    'Times New Roman''>
                  <o:p></o:p>
                  </span></p></td>
            </tr>
    ...
    mso-fareast-font-family:&quot;Times New Roman&quot;;color:#555454;text-transform:
    uppercase'>silhouettehair.com</span> login details
                          <o:p></o:p>
                          </span></p>
                      </div>
    ...
    background:#F8F8F8;padding:5.25pt 0in 5.25pt 0in'><table class=MsoNormalTable border=0 cellpadding=0 width='100%'
     style='width:100.0%;mso-cellspacing:1.5pt;mso-yfti-tbllook:1184'>
                  <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
                    ...
                    <td style='padding:5.25pt 0in 5.25pt 0in'><p class='MsoNormal1'>Thank you for your registeration with silhouettehair.com</p>
                      ...
                      <p class='MsoNormal1'>step B - Fax(847-364-9926) or E-mail (info@silhouettehair.com) your copy of certificate or license </p>
                      <p class='MsoNormal1'>&nbsp; </p>
    ...
    mso-fareast-font-family:&quot;Times New Roman&quot;;color:#555454;text-transform:
    uppercase'><a href='silhouettehair.com'>silhouettehair.com</a></span></span></p></td>
            </tr>
  ...
  <p class=MsoNormal><span style='mso-fareast-font-family:'Times New Roman''>
    <o:p>&nbsp;</o:p>
         ...
         $headers =  "From:silhouettehair.com\r\n";
 ...
 header("location:sign_in.php?email=$email");
 }
  }
else{
header("location:wholesale_register.php");	
}
