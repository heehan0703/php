...
header("location:login.php");	
	exit;
	 ...
	 if(isset($_POST['submit']))
	 {
		 ...
		 $seo_tags=$_POST['seo_tages'];
		 $rec = "insert into category (category_name,seo_tags,page_title) values ('$name','$seo_tags','$page_title')";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          ...
                          <td width="99%" class="blue-bx-topmid-bg" ><table width="100%" border="0" cellspacing="5" cellpadding="0">
                            ...
                            <tr>
                              ...
                              <td align="left" class="white-18">Add Category</td>
     ...
     <input type="text" name="Id" id="Id" class="form-group" style="width:220px"  ></td>
     </tr>
     <tr>
     <td width="30%" align="right" colspan="4">Page Title</td>
     <td width="40%" align="left" colspan="4">
     <textarea  cols="25" rows="3" name="page_title"></textarea>
     </td>
     </tr>
     ...
     <td width="40%" align="left" colspan="4">
     <textarea  cols="25" rows="3" name="seo_tages"></textarea>
     </td>
     </tr>
