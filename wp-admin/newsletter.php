...
{
	//echo "dhirendra";
	$query3=mysql_query("delete from `newsletter_new` where id='$id'");
	  
}
$wig_list_query=mysql_query("SELECT * FROM newsletter_new  order by id desc");
?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
     ...
     <th width="12%" align="left">fullname</th>
     <th width="15%" align="left">email</th>
     <th width="15%" align="left">phone</th>
     <th width="30%" align="left">job</th>
     ...
     <td width="20%" align="left"><?=$wig_list_row['fullname']?></td>
     <td width="20%" align="left"><?=$wig_list_row['email']?></td>
     <td width="20%" align="left"><?=$wig_list_row['phone']?></td>
     <td width="30%" align="left"><?=$wig_list_row['job']?></td>
     <th width="30%" align="left"><a href="./newsletter.php?act=delete&newsid=<?=$wig_list_row['id']?>" onclick="return(YNconfirm());">Delete </a></th>
