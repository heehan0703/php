...
$id=$_GET['id'];
$row=mysql_fetch_array(mysql_query("select * from couponcode where id='$id'"));
	 if(isset($_POST['submit']))
	 {
		 $code=$_POST['code'];
		 $codevalue=$_POST['codevalue'];
		 $type=$_POST['type'];
		 $read= "update couponcode set value='$codevalue',type='$type',code='$code' where id='$id'";
	//echo $record;
...
function Validation()
{
	var sub=document.getElementById('Id').value;
...
#body_container {
	background-image: url("../../../hair club/working/wp-admin/images/strip.png");
...
.background-img {
	background-image: url('image/flower_strip.png');
	height: 130px;
}
.atss {
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          ...
                          <td width="99%" class="blue-bx-topmid-bg" ><table width="100%" border="0" cellspacing="5" cellpadding="0">
                            ...
                            <tr>
                              ...
                              <td align="left" class="white-18">Add Coupon</td>
     ...
     <tr>
     <td width="30%" align="right" colspan="4">Coupon Code</td>
     <td width="40%" align="left" colspan="4">
     <input type="text" name="code" id="Id" class="form-group" style="width:220px"  value="<?=$row['code']?>"  ></td>
     </tr>
     <tr>
     <td width="30%" align="right" colspan="4">Coupon Value</td>
     <td width="40%" align="left" colspan="4">
     <input  type="text" name="codevalue"  value="<?=$row['value']?>" />
     </td>
     </tr>
     
     <tr>
     <td width="30%" align="right" colspan="4">Coupon Type</td>
     <td width="40%" align="left" colspan="4">
     <select name="type">
