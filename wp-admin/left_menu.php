...
<ul>
  ...
  <li><a href="message_list.php"><img src="images/lite-blue-arrow.png" width="4" height="6" /> &nbsp;&nbsp;Message List</a></li>
   ...
   <li><a href="catagory_management.php"><img src="images/lite-blue-arrow.png" width="4" height="6" /> &nbsp;&nbsp;Catogary Management</a></li>
</ul>
                    <? } ?>
...
<ul>
  ...
  <li><a href=""><img src="images/lite-blue-arrow.png" width="4" height="6" /> &nbsp;&nbsp;Beauty News</a></li>
                    ...
                    <? } ?>     
                      ...
                      <? if($tab_menu=='store'){?>
<ul>
  <li><a href="add_store.php"><img src="images/lite-blue-arrow.png" width="4" height="6" /> &nbsp;&nbsp;Add store</a></li>
