...
*/
 $query=mysql_query("SELECT * FROM `couponcode` order by id asc ");
 $id=$_GET['id'];
$cat_id=$_GET['cat_id'];

if($_GET['act']=='delete')
{
	$query3=mysql_query("delete from `couponcode` where id='$id'");
	 //echo "delete from `category` where id='$id';";
                        ...
                        <tr>
                          ...
                          <td width="99%" class="blue-bx-topmid-bg" ><table width="100%" border="0" cellspacing="5" cellpadding="0">
                            ...
                            <tr>
                              ...
                              <td align="left" class="white-18">Coupon Code  List</td>
	<td width="5%" align="left"><a href="add_new_coupon.php" class="white-18" style="margin-left: -184px;">ADD New Coupon Code </a></td>
                            </tr>
     ...
     <th width="20%" align="left">Coupon Code </th>
     <th width="20%" align="left">Coupon Code value </th>
     <th width="20%" align="left">Coupon Code type </th>
     <th width="25%" colspan="2">Action</th>
     </tr>
    <?php $count=0;  while($category=mysql_fetch_assoc($query)){ $count++;
     ?>
    
    <tr><th width="5%" align="center"><?=$count?></th>
     <th width="20%" align="left"><?=$category['code']?> </th>
     <th width="20%" align="left"><?=$category['value']?> </th>
     <th width="20%" align="left"><?=$category['type']?> </th>
     <th width="25%" colspan="2"><a href="edit_coupon.php?act=edit&id=<?=$category['id']?>">EDIT </a> &nbsp;&nbsp;&nbsp; <a href="managecoupon.php?act=delete&id=<?=$category['id']?>">DELETE </a></th>
     </tr>
