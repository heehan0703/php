                        ...
                        <tr>
                          ...
                          <td width="99%" class="blue-bx-topmid-bg" ><table width="100%" border="0" cellspacing="5" cellpadding="0">
                            ...
                            <tr>
                              ...
                              <td align="left" class="white-18">Category List</td>
	<td width="5%" align="left"><a href="add_new_category.php" class="white-18" style="margin-left: -184px;">ADD New Category </a></td>
                            </tr>
     ...
     <tr><th width="5%" align="center">Num</th><th width="70%" align="left">Category Name</th><th width="25%" colspan="2">Action</th></tr>
    <?php $count=0;  while($category=mysql_fetch_assoc($query)){ $count++;
     ?>
     
     <tr><td width="5%" align="center"><?=$count?></td><td width="70%" align="left"><?=$category['category_name']?></td>
     <td width="8%" align="center"><a href="subcategory_manage.php?cat_id=<?=$category['id']?>">Subcategory</a></td>
     <td width="8%" align="center"><a href="edit_category.php?act=edit&id=<?=$category['id']?>">EDIT </a></td>
     <td width="8%" align="center"><a href="category_manage.php?act=delete&id=<?=$category['id']?>">DELETE </a></td>
     </tr>
       <?php }  ?> 
                      </table>
                      </td>
