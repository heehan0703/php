...
if(isset($_POST['submit'])){
	  ...
	  $sql = "INSERT INTO Manage_Store (store_id,shipping_type,price,no_days) VALUES ('$id','$shipping_type', '$price', '$no_days')";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          ...
                          <td width="99%" class="blue-bx-topmid-bg" ><table width="100%" border="0" cellspacing="5" cellpadding="0">
                            ...
                            <tr>
                              ...
                              <td align="left" class="white-18"> Manage Store </td>
                              
                              <td align="left" class="white-18"> <a href="manage_time.php?id=<? echo $id?>">Manage Time</a> </td>
                              <td align="left" class="white-18"> <a href="pickup.php?id=<? echo $id?>">Pickup</a> </td>
  ...
  <label for="Standard_shipping">Store ID</label>
  <input  type="text" name="store_id" maxlength="50" size="30" value="<? echo $id?>" readonly="readonly">
<table align="center"> <tr>
    <th width="30%" align="left">Shipping Type</th>
    <th width="20%" align="left">Price</th>
    <th width="21%" align="left">Delivery Time</th>
</tr>  </table>
                       ...
                       <table align="center">
                      <tr> <td valign="top">
  <input  type="text" name="shipping_type" maxlength="50" size="30" value="">
  <input  type="number" name="price" maxlength="50" size="30" value="">
  <input  type="number" name="no_days" maxlength="50" size="30" value="">
 </td>
</tr>
