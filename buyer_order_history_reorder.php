...
<div class="col-lg-10 col-md-10 col-sm-11 col-xs-11"><h4 class="h4">My Account > Order History</h4></div>
</div>
        ...
        <div class="full"> 
          ...
          <div class="full small-hidden" style=" border-bottom:1px solid #CCCCCC; padding:.7em 0;">
            <div class="col-lg-4" align="center" style=" padding:.5em 0;">
              <div class="full">
                <div class="col-lg-5"><img width="83" height="74" alt="" src="https://fahair.com/images/pic3.jpg"></div>
                <div class="col-lg-7" style="padding-top:1em;"><a href="">REMY FORTE SW14</a></div>
              </div>
            </div>
            <div class="col-lg-2" align="center" style=" padding:.5em 0;padding-top:1em;">COLORS <span 
 style="background:#DDFFFB; min-height:20px; min-width:25px;display:inline-block;">1</span><br>
              Length<span style="background:#DDFFFB; min-height:20px; min-width:25px;display:inline-block;">14</span> </div>
            <div class="col-lg-2" align="center" style="padding:.5em 0;padding-top:1em;">$40.00</div>
            <div class="col-lg-2" align="center" style=" padding:.5em 0;">
              <input type="text" value="1" size="2" name="cnt">
              <br><br>
      ...
      <div class="col-md-5 col-sm-5 col-xs-5"><img width="83" height="74" alt="" src="https://fahair.com/images/pic3.jpg"></div>
      <div class="col-md-7 col-sm-7 col-xs-7"><a href="">REMY FORTE SW14</a></div>
      </div>
       <div class="full" style="padding:.7em 0;">
      <div class="col-md-5 col-sm-5 col-xs-5">Option</div>
      <div class="col-md-7 col-sm-7 col-xs-7">COLORS<span style="background:#DDFFFB; min-height:20px; min-width:25px; display:inline-block;">14</span><br>
Length<span style="background:#DDFFFB; min-height:20px; min-width:25px; display:inline-block;">14</span><br>      
      </div>
      </div>
       <div class="full" style="padding:.7em 0;">
      <div class="col-md-5 col-sm-5 col-xs-5">Price</div>
      <div class="col-md-7 col-sm-7 col-xs-7">$40.00  </div>
      </div>
      <div class="full" style="padding:.7em 0;">
      <div class="col-md-5 col-sm-5 col-xs-5">Quantity</div>
      <div class="col-md-7 col-sm-7 col-xs-7"><input type="text" value="1" size="2" name="cnt">
       <input type="button" class="red-btn" value="Update" style="background:#2685B3; padding:.2em;">  </div>
      </div>
       <div class="full" style="padding:.7em 0;">
    ...
    <div class="col-lg-7 col-md-5 col-sm-7 col-xs-7" style="padding:.3em 0;">DQH7254336</div>
    </div>
   ...
   <div class="full" style="border-bottom:1px solid #666666;">
    ...
    <div class="col-lg-7 col-md-5 col-sm-7 col-xs-7" style="padding:.3em 0;">2014-08-05 11:59:03</div>
    </div>
     <div class="full" style="border-bottom:1px solid #666666; ">
   ...
   <!-- payment info start --> 
    ...
    <div class="col-lg-7 col-md-5 col-sm-7 col-xs-7" style="padding:.3em 0;">$42.00</div>
    </div>
   ...
   <div class="full" style="border-bottom:1px solid #666666;">
    ...
    <div class="col-lg-7 col-md-5 col-sm-7 col-xs-7" style="padding:.3em 0;"><b>Credit Card</b></div>
    </div>
   <!-- payment info end --> 
      
      <div class="full" style="margin-top:2em; ">
    Message<br>
    <textarea class="full" rows="7"></textarea>  
      </div>
    <div class="full" style="margin-top:1.5em;margin-bottom:4em;">
  <div class="col-lg-8 col-md-6 col-sm-6 col-xs-6 text-center">
  <input type="button" class="red-btn" value="RE ORDER" style="font-size:1.2em;padding:.3em 1.2em;" >
  </div>
