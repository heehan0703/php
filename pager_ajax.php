...
if ($pagegroup== ""){
   ...
   /* if (($curpage != 1) && ($curpage)) 
    ...
    { 
       ...
       $page_list .= "<a href=\"goods_list.php?page=".($spage).$str1."\" title=\"Previous Page\" class=\"blue-12\"><b>Previous $limitset pages..</b></a> ";
    } 
     ...
     { 
	  ...
	  if ($i > ($startpage + $limitset))
       ...
       { 
         ...
         $page_list .= ""."<li class=\"active\"><a ><b>".$i."</b></a></li>"; 
       } 
       else 
       { 
         $page_list .= "<li><a  onclick=\"dhirendra($i)\">".$i."</a></li>";
       } 
       $page_list .= " "; 
     } 
    $nextgrouppage = $pagegroup * $limitset;
     ...
     { 
	   ...
	   $page_list .="<a href=\"goods_list.php?page=".($spage).$str1."\" title=\"Next PageSet\" class=\"blue-12\"><b>..Next $limitset Pages</b></a> ";
     } 
     $page_list .= "\n"; 
     return $page_list; 
    } 
