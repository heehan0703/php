...
<div class="full" id="body_container">
  <div class="container">
   ...
   <h4 class="h4" style="color:#000;">Agent account information</h4> 
   <hr> </div>
      <div class="row form-group " style="width:96%; margin:1% 2%; background:#FFF; padding:1%;">
     
     
	 <form name="register" action="register_process_agent.php"  method="post" onSubmit="return Validate()">
...
<?=$state_row['state_name']?></option>	 
 <? } ?>
          ...
          <div class="col-lg-8 col-sm-12 col-xs-12">
 <input type="radio" name="i_am" value="Agent" class="radio-inline" checked="checked" ><b>Agent</b>
       <!--  <input type="radio" name="i_am" value="Wholesaler" class="radio-inline"  >Wholesaler -->
...
<div class="full" style="margin:.7em 0;">
          <div class="col-lg-4 col-sm-12 col-xs-12 text-right"><sup><img src="images/star_red.png" ></sup> Recruiter:</div>
          <div class="col-lg-8 col-sm-12 col-xs-12">
       <input type="text" name="ReferralPerson" id="Recruiter" class="form-control" style="width:80%; float:left;border-radius: 3px 0px 0px 3px;" >
          </div>
          </div>
