...
<div class="full" id="body_container">
  <div class="container">
    ...
    <div class="row" style="padding:1em;"> <span class="glyphicon glyphicon-home"></span>&nbsp;Home &nbsp;&nbsp;/&nbsp;Authentication<br>
      <span style="color:#222222">WELCOME</span> </div>
    <hr>
   ...
   <h4 class="h4" style="color:#000;"></h4> 
   <hr> </div>
    ...
    <span style="color:#333333; font-weight:bold;" >Welcome to EBHAhair.com </span> &nbsp;<br/>



    <span  style="color:#333333;width:65%; font-weight:bold;">Your own  coupon code is</span>
    </div>  
    
    
     <div class="full" style="width:95%; margin:0em 0em 2em 1em; margin-left:3%;">
        <span style="color:#333333; background-color:#FFFF00; line-height:30px; font-weight:bold;" ><?=$_GET['refcode']?></span> 
    
    </div> 
      <p>Now you can tell your friends and family  to use your 15% off  coupon code.</p>
<p>Everytime code is used  15% commission will go directly to your account.</p>
         
           
           
       <div class="full" style="width:95%; margin:0em 0em 2em 1em; margin-left:3%;">
          <span style="color:#333333; line-height:30px; font-weight:bold;" >Share your Friends </span> 
       ...
       <div class="full" style="width:95%; margin:0em 0em 2em 1em; margin-left:3%;">
          <span style="color:#333333; line-height:30px; font-weight:bold;" >Hi Friends </span> 
    
       </div>   
       
        <div class="full" style="width:95%; margin:0em 0em 2em 1em; margin-left:3%;">
        
         <div style="width:40%; border:4px dashed #003300;">
          <span style="color:#333333; line-height:30px; font-weight:bold;" >15% Sale all Hair & Wig Products Coupon Code is</span> <br/>
          <span style="color:#FF0000; line-height:30px; font-weight:bold; font-size:16px" > &nbsp;<?=$_GET['refcode']?></span> 
         </div> 
        ...
        <div class="full" style="width:95%; margin:0em 0em 2em 1em; margin-left:3%;">
          <span style="color:#333333; line-height:30px; font-weight:bold;" >Check EBHAhair.com</span> 
...
<p>To begin an arbitration proceeding, you must send a letter requesting arbitration and describing your claim to our registered agent Corporation Service Company____________________________________________________________________________________________________________________________________________________________________________
