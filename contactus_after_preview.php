...
<div class="full"> 
  ...
  <div class="full" id="">
    ...
    <div class="container" style="">
         <div class="full small-hidden full-hidden" style=" background:#17B4BB;">
         <div class="full" style=" background:#17B4BB;">
                    <div class="col-lg-2 col-md-6 col-sm-6 col-xs-6">
                    <img src="images/bulkorder_1-logo.png" class="img-thumbnail" style="border:0px; background:#17B4BB;" >                    </div>
                    <div class="col-lg-2 col-md-6 col-sm-6 col-xs-6">
                    <h2 class="h2" style="color:#FFF; height:50px;">Contact Us</h2>
                    </div>
          </div></div>
          ...
          <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
           ...
           <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"></div>
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-11">
                     <p>International Call : 1-847-621-2289</p>
                    </div></div>
