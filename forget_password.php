...
$member_password =$member_details['pwd'];
...
$body = "<html><body>
         <p>User Email Id and Password Details</p>
          <table border ='2'>
          <tr><td> Email :</td><td>$member_email</td></tr>
           <tr><td> Password :</td><td>$member_password</td></tr>
          </table>
           </body></html>";
...
<div class="full" id="body_container">
  <div class="container">
    ...
    <div class="row" style="padding:1em;"> <span class="glyphicon glyphicon-home"></span>&nbsp;Home &nbsp;&nbsp;/&nbsp;Authentication<br>
      <span style="color:#222222">Forgot Password</span> </div>
    <hr>
   ...
   <h4 class="h4" style="color:#000;">Forgot Password</h4> 
   <hr> </div>
    ...
    <span style="color:#999999; font-weight:bold;" >Forgot Password</span> &nbsp;
    <span class="dotted-class" style="width:65%;"></span>
    </div>   
      
         <div class="full" style="margin:.7em 0;">
          <div class="col-lg-4 col-sm-12 col-xs-12 text-right"><sup><img src="images/star_red.png" ></sup>Enter your Email:</div>
          <div class="col-lg-8 col-sm-12 col-xs-12">
            <input type="email" name="email" id="email" class="form-control" style="width:50%; float:left;border-radius: 3px 0px 0px 3px;" > &nbsp; &nbsp;&nbsp;&nbsp;
            <input type="submit" name="submit" id="submit" value="Send" class="blue-btn" style="text-align:center;" onClick="mail_send()">
            <script>
function mail_send() {
    alert("Your password send to your Email id");
}
</script>
          </div>
          </div>
