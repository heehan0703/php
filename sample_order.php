...
'$product_length','$product_color','$product_quantity','$product_dropship','$time')");
  ...
  <table>
  <tr><td width='30%'><img style='border:0px; background:#94C95F;' src='https://fahair.com/images/logo1.png'> </td>
...
<form method="post" action="" name="custom_orderForm">
  ...
  <div class="full" style=" background:#94C95F;">
  <div class="col-lg-2 col-md-6 col-sm-6 col-xs-6">
    
    <img src="images/logo_1.png" class="img-thumbnail" style="border:0px; background:#94C95F;" >          
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
      <h2 class="h2" style="color:#FFF; height:50px;">Sample Order</h2>
      </div>
      <? if($mail_variable==true){?>
      <br>
      <h3 class="h3 full" style="color:#FFF; height:50px;">Thanking You. One of our Adminisitrator will contact you as soon as 
      possible</h3> <? } ?> 
  </div>
 ...
 <div class="col-lg-6">
  ...
  <div class="full" style="border-bottom:2px solid #E5E5E5;">
  <div class="col-lg-6"><input type="text" class="form-group" name="company_name" id ="company_name" value="<?=$user_row['company_name']?>" ></div><div class="col-lg-6">Company Name</div>
  </div>
   <div class="full" style="border-bottom:2px solid #E5E5E5;">
  <div class="col-lg-6"><input type="text" class="form-group" name="address1" id="address1" value="<?=$user_row['address1']?>" ></div><div class="col-lg-6">Street Address</div>
  </div>
  <div class="full" style="border-bottom:2px solid #E5E5E5;">
  <input type="text" class="" value="<?=$user_row['address2']?>" name="address2" style="width:96%; margin:0 2%;"><br>
  Street Address Line 2
  </div>
   <div class="full" style="border-bottom:2px solid #E5E5E5;">
  <div class="col-lg-6" style="border-right:2px solid #e5e5e5;">
  <input type="text" class="form-group" value="<?=$user_row['city']?>" id="city" name="city" ><br>City</div>
  <div class="col-lg-6"><input type="text" value="<?=$state_name?>" name="state" id ="state" class="form-group" ><br>State / Province</div>
  </div>
   <div class="full" style="border-bottom:2px solid #E5E5E5;">
  <div class="col-lg-6" style="border-right:2px solid #e5e5e5;">
  <input type="text" class="form-group" name="zipcode" id="zip"  value="<?=$user_row['zipcode']?>"><br>Postal / Zip Code</div>
  <div class="col-lg-6"><select name="country">
  ...
  <div class="col-lg-6" style="border-left:2px solid #e5e5e5;"><input type="email" name="email" id="email" value="<?=$user_row['email']?>" ></div>
  </div>
   <div class="full" style="">
  <div class="col-lg-6">Phone</div>
  <div class="col-lg-6" style="border-left:2px solid #e5e5e5;"><input type="text" name="cel" id ="cel" value="<?=$user_row['cel']?>" ></div>
  </div>
  ...
  <div class="full" style="border-bottom:2px solid #E5E5E5; min-height:20px;"></div>
  <div class="full" style="border-bottom:2px solid #E5E5E5;">
  <div class="col-lg-6"><input type="text" name="rcompany_name" id="rcompany_name" class="form-group" ></div><div class="col-lg-6">Company Name</div>
  </div>
   <div class="full" style="border-bottom:2px solid #E5E5E5;">
  <div class="col-lg-6"><input type="text" name="raddress1" class="form-group" id ="raddress1" ></div><div class="col-lg-6">Street Address</div>
  </div>
  <div class="full" style="border-bottom:2px solid #E5E5E5;"><input type="text" name="raddress2" id="raddress2" class="" style="width:96%; margin:0 2%;"><br>
  Street Address Line 2
  </div>
   <div class="full" style="border-bottom:2px solid #E5E5E5;">
  <div class="col-lg-6" style="border-right:2px solid #e5e5e5;"><input type="text" name="rcity" id="rcity" class="form-group" ><br>City</div>
  <div class="col-lg-6"><input type="text" name="rstate" id="rstate" class="form-group" ><br>State / Province</div>
  </div>
   <div class="full" style="border-bottom:2px solid #E5E5E5;">
  <div class="col-lg-6" style="border-right:2px solid #e5e5e5;"><input type="text" name="rzipcode" id="rzip" class="form-group" ><br>Postal / Zip Code</div>
  <div class="col-lg-6"><select name="rcountry">
  <option>Please Select</option>
  <?php
   ...
   <div class="full" style="border-bottom:2px solid #E5E5E5;">
  <div class="col-lg-6">E-mail</div>
  <div class="col-lg-6" style="border-left:2px solid #e5e5e5;"><input type="email" name="remail" id="remail" ></div>
  </div>
   <div class="full" style=" ">
  <div class="col-lg-6" >Phone</div>
  <div class="col-lg-6" style="border-left:2px solid #e5e5e5;"><input type="text" name="rcel" id="rcel" ></div>
  </div>
  ...
  <div class="col-lg-9 col-sm-7 col-xs-7 col-md-7">
          <select name="pay" id="p_type">
 ...
 <div class="col-lg-3 small-border-hddn" style="border-right:2px solid #B3B3B3;">Product Type</div>
  ...
  <select name="product_category[]" class="product_category" style="min-height:26px;" onBlur="pass_val('product_category')">
  ...
  <input type="text" name="product_name[]" class="product_name" id="product_name" onBlur="pass_val('product_name')" placeholder="Product Name" ></div>
  <div class="col-lg-3 small-border-hddn" style="border-right:2px solid #B3B3B3;">
   <input type="text" name="product_length[]" class="product_length" onBlur="pass_val('product_length')" placeholder="Length" >
  </div>
  <div class="col-lg-1 small-border-hddn" style="border-right:2px solid #B3B3B3;">
   <input type="text" name="product_color[]" class="product_color" onBlur="pass_val('product_color')" size="3" placeholder="Color" >
  </div>
   <div class="col-lg-1 small-border-hddn" style="border-right:2px solid #B3B3B3;">
   <input type="text" name="product_quantity[]" class="product_quantity" onBlur="pass_val('product_quantity')" size="3" placeholder="Quantity" >
  </div>
  <div class="col-lg-2 small-border-hddn" style=""><select name="product_dropship[]" class="product_dropship" onBlur="pass_val('product_dropship')">
  ...
  <option value="Yes">Yes</option>
   ...
   <div class="full" style="">
  <div class="col-lg-4 small-border-hddn" style="border-right:2px solid #B3B3B3;">
  <img src="https://fahair.com/images/add_icon.jpg" style="cursor:pointer;" onClick="add_option_row()" ></div>
  <div class="col-lg-2 small-border-hddn" style="border-right:2px solid #B3B3B3;min-height: 23px;"></div>
  <div class="col-lg-3 small-border-hddn" style="border-right:2px solid #B3B3B3;min-height: 23px;"></div>
  <div class="col-lg-1 small-border-hddn" style="border-right:2px solid #B3B3B3;min-height: 23px;"></div>
  <div class="col-lg-2 small-border-hddn" style="min-height: 23px;"></div>
  </div>
  ...
  <input type="submit" class="red-btn" name="submit" value="Sample Order" style="font-size:1.2em;" >
  </div>
...
<div class="col-lg-6" style="margin-bottom: 20px;"><h1 style="margin-top: 0px; margin-bottom: 0px;">Sample Order</h1><br>
