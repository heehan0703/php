...
if($_SESSION['i_am']=='Wholesaler' or $_SESSION['i_am']=='ISR' or $_SESSION['i_am']=='Agent' or  $_SESSION['i_am']=='General Buyer'){ 
        ...
        if($status=='Success' || $status=='SuccessWithWarning')
		 ...
		 else
		 {
			...
			<script type="text/javascript">
			 ...
			 window.location = "https://ebhahair.com/checkout-new.php"
	         </script>		
...
header("location: https://ebhahair.com/order_ok.php?tradecode=$tradecode");
}	
