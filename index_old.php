							...
							<div class="title-container s-tb-c title-compress">
								<div class="slider-1">
									<div class="wow fadeInUpBig" data-wow-duration="1.2s" data-wow-delay="0.5s">
										<h1 class="title1"><font color="green">EBHA</font></h1>
                                        <BR><!--<IMG SRC="images/EBHA_BOBSA-01.png">-->
									</div>
									<div class="image wow fadeInUpBig" data-wow-duration="1.5s" data-wow-delay="0.7s">
										<span><a href="http://ebha.fahair.com/"><img src="shopick/img/slider/slider-1/slider-border.png" alt="" border="0" /></a></span>
									</div>
					...
					<div id="slider-direction-2" class="slider-direction">
						...
						<div class="slider-content t-lfl s-tb">
							<div class="title-container s-tb-c title-compress">
								<div class="slider-1">
									<div class="wow fadeInUpBig" data-wow-duration="1.2s" data-wow-delay="0.5s">
										<h3 class="title1"><font color="#FFFFFF">The Best Hair Wholesaler </font></h3><BR><!--<IMG SRC="images/EBHA_BOBSA_W.png">-->
									</div>
									<div class="image wow fadeInUpBig" data-wow-duration="1.5s" data-wow-delay="0.7s">
										<span><a href="http://ebha.fahair.com"><img src="shopick/img/slider/slider-1/slider-border.png" alt="" border="0" /></a></span>
									</div>
					...
					<div id="slider-direction-3" class="slider-direction">
						...
						<div class="slider-content t-lfl s-tb">
							<div class="title-container s-tb-c title-compress">
								<div class="slider-1">
									<div class="wow fadeInUpBig" data-wow-duration="1.2s" data-wow-delay="0.5s">
										<h3 class="title1">Weaves,Wigs,Braids&amp;Pieces</h3><BR>
									</div>
									<div class="image wow fadeInUpBig" data-wow-duration="1.5s" data-wow-delay="0.7s">
										<span><a href="http://ebha.fahair.com/wigs/"><img src="shopick/img/slider/slider-1/slider-border.png" alt="" border="0" /></a></span>
									</div>
									<div class="wow fadeInUpBig" data-wow-duration="1.8s" data-wow-delay="0.9s">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12" style="margin:0px; padding:0px; alignment-adjust:central">
			...
			<div class="new-collection-area fix margin-bottom-80">
				...
				<div class="col-lg-4 col-md-6 col-sm-6 padding-0">
					<div class="single-collection">
						<div class="collection-photo">
							<a href="http://ebha.fahair.com/top-pieces/"><img src="images/EBHA_EVOTWIN.jpg" alt="" border="0" /></a>
						</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-6 padding-0">
					<div class="single-collection">
						<div class="collection-photo">
							<a href="http://ebha.fahair.com/wigs/"><img src="images/EBHA_DEJA.jpg" alt="" border="0" /></a>
						</div>
					  <div class="collection-brief">
							<div class="text-right">
				...
				<div class="col-lg-4 hidden-md hidden-sm padding-0 ">
					<div class="single-collection">
						<div class="collection-photo">
							<a href="http://ebha.fahair.com/wigs/"><img src="images/EBHA_BRAID.jpg" alt="" border="0" /></a>
						</div>
					  <div class="collection-brief">
							<div class="text-right">
