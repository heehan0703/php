...
// print_r($length_option_arr);
 ...
 // $_SESSION['level']=2;
  ...
  $product_stock=explode(',',$product_info['stock']);
   ...
   $product_price_wholesale=explode(',',$product_info['wholesaleprice2']);
...
'$product_length','$product_color','$product_quantity','$product_dropship','$time')";
  ...
  <table>
  <tr><td width='30%'><img style='border:0px; background:#94C95F;' src='https://fahair.com/images/sample_order-logo.png'> </td>
...
<tr>
<td> <img src='https://fahair.com/product_img/$product_img' style='width: 200px; height: 150px;'></td>
</tr>
...
<html class="no-js" lang="">
    <head>
        ...
        <title>Single-Product || Shopick</title>
...
product_price_wholesale[<?=$i?>]= <?=$product_price_wholesale[$i]?>;
 <? }}?>
...
product_price_regular[<?=$i?>]= <?=$product_price_regular[$i]?>;
 <? }}?>
...
<? } ?>
optionpriceArr[<?=$i?>]= <?=$product_price[$i]?>;
<? } else {?>
optionpriceArr[<?=$i?>]= <?=$product_price[$i]?>;
<? } ?>
							...
							<div class="single-product-tab-content">
								...
								<div class="tab-content">
									<div role="tabpanel" class="tab-pane active" id="img-one">
										<img src="/product_img/<?=$product_img?>" alt="" />
	                            ...
	                            ?>
									<div role="tabpanel" class="tab-pane" id="<?=$j?>">
										<img src="./product_img/<?=$new_imagesmall?>" alt="" />
	   ...
	   ?>
						...
						<div class="col-md-7 col-sm-7 col-xs-12">
							<div class="single-product-description">
								<h3 class="title-3"><?=$product_info['product_name']?></h3>
								<h4> <? if($_SESSION['level']!=2){?>
                     <b>
                 ...
                 <? if( $length_option_count==0){?> $
                    ...
                    <strike><span id="price_span"><?=$product_info['msrp_price']?>  </span> </strike>,
                   
                    <? }else{ ?> $
                    
                    <strike> <span id="price_span"><?=$product_price[0]?>  </span></strike> ,
				...
				<span id="price_wholesale_span" style="color:#F00;"><?=$product_info['wholesale_price']?> </span>
                <? }else{ ?>
                <span id="price_wholesale_span" style="color:#F00;"><?=$product_price_wholesale[0];?> </span>
                <? } ?>
											...
											<ul>
												<li>
													<div class="product-comments">
														<img src="/shopick/img/author.jpg" alt="" />
		   ...
		   ?>
					...
					<div class="single-product">
						...
						<div class="product-brief">
							<h2><a href="/<?=$producturl1?>-<?=$new_arrival1['id']?>.html"><?php echo $new_arrival1['product_name']?></a></h2>
