...
if($subcat == '')
{
//echo "SELECT * FROM `product` order by product_seen DESC";
...
//echo  "SELECT * FROM `product` where category = '$text_show' and subcategory='$subcat' ORDER BY product_seen DESC";
}
$j=0;
