...
window.location="https://ebhahair.com/agent/";
</script>';	 
...
<div class="full" id="body_container">
  <div class="container">
    ...
    <h3 align="center">Welcome to Ebhahair.com</h3>
         ...
         <p><strong><font color="red">You need to purchase one of agent package items to become an agent.</font></strong></p>
...
<?php include'https://ebhahair.com/agent/'?>
