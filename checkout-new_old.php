...
<html class="no-js" lang="">
    <head>
		...
		<!-- flaticon css -->
        <link rel="stylesheet" href="../shopickcss/shopick-icon.css">
		<!-- pe-icon-7-stroke css -->
        <link rel="stylesheet" href="../shopickcss/pe-icon-7-stroke.css">
		<!-- lightbox css -->
        <link rel="stylesheet" href="../shopickcss/lightbox.min.css">
		<!-- style css -->
		<link rel="stylesheet" href="../shopickstyle.css">
		<!-- responsive css -->
        <link rel="stylesheet" href="../shopickcss/responsive.css">
		<!-- modernizr css -->
        <script src="../shopickjs/vendor/modernizr-2.8.3.min.js"></script>
    </head>
    <body>
        <!--[if lt IE 8]>
						...
						<form action="#">
							<div class="row">
								<div class="col-md-6">
									...
									<h4 class="title-8">Ship to a different address <input type="checkbox" checked="checked" /></h4>
									<div class="row coupon-info">
										<div class="col-md-6">
											<p class="form-row-first">
												<label>Username or email <span class="required">*</span></label>
