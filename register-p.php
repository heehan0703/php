<? ob_start() if(basename($_SERVER['REQUEST_URI'])=='register.php'){header("location:http://example.com",  true,  301 );  exit;}?>
<?php
 session_start();
 ...
 //echo $_SESSION['GOOD_SHOP_USERID'];
 /*
$to  = 'Jane@fahair.com' . ', '; // note the comma
...
$headers .= 'To: Jane <Jane@.com>, Kelly <kelly@example.com>' . "\r\n";
$headers .= 'From: General Member <>' . "\r\n";
...
<html>
<head>
<meta content="<p>Welcome to Fahair.com</p>" name="description">
	...
	<?php } ?>
      ...
      <script type="text/javascript">
		...
		$("#state_div").hide('fast');		
          ...
          <div class="col-lg-8 col-sm-12 col-xs-12">
        <select name="state" id="state" style="width:80%;" >
<option value="" selected="selected">Select State</option>		
    ...
    <span class="dotted-class" style="width:65%;"></span>
        ...
        <div class="full" style="margin:.7em 0;">
          ...
          <div class="col-lg-8 col-sm-12 col-xs-12">
          <div  class="row">
                <div class="col-lg-4 col-sm-12 col-xs-12" ><input type="text" class="input-group-sm" name="f_name" id="f_name" placeholder="First Name" > </div>
                <div class="col-lg-4 col-sm-12 col-xs-12"  style="text-align:left"><input type="text" class="input-group-sm" name="l_name" id="l_name" placeholder="Last Name" ></div>
       ...
       <input type="text" name="com_name" id="com_name" class="form-control" style="width:80%; float:left;border-radius: 3px 0px 0px 3px;" >
          ...
          <div class="col-lg-8 col-sm-12 col-xs-12">
            <div  class="row">
                  <div class="col-lg-12 col-sm-12 col-xs-12"><input type="text" name="tel1" id="tel1" class="input-xm" style="width:45px; display:inline;" >-<input type="text" name="tel2" id="tel2" class="input-xm" placeholder="Area" style="width:45px; display:inline;">-<input type="text" name="tel3" id="tel3" class="input-group-sm" placeholder="Number" style="width:100px;margin-left:0px; display:inline;"></div>
          ...
          <div class="col-lg-12 col-sm-12 col-xs-12">
                   <input type="text" name="cel1" id="cel1" class="input-xm" style="width:45px; display:inline;" >-<input type="text" name="cel2" id="cel2" class="input-xm" placeholder="Area" style="width:45px; display:inline;">-<input type="text" name="cel3" id="cel3" class="input-group-sm" placeholder="Number" style="width:100px;margin-left:0px; display:inline;">              </div>
           </div>      
          </div>
          </div>  
    ...
    <span class="glyphicon glyphicon-repeat" onClick="document.getElementById('captcha').src='captcha.php?'+Math.random();" style="cursor:pointer;"></span>      
       ...
       <input type="text" name="captcha1" id="captcha1" class="input-group-sm" >
          </div>
          </div>
     ...
     Upon creating my account I agree to:<br>
      ...
      <input type="checkbox" class="checkbox-inline" id="checkbox2"> Receive emails relating to membership and services from  
