...
'$ship_city','$ship_state','$ship_country','$ship_zipcode','$total_weight','$shipping_charge_other_countery','$service_choose','$addinfo','$billphone','$shipphone','$address2','$ship_address2','$discountval','$storepickup','$type','$ISR','$usedcoupon','$credit_used','$remaining_credit','$SubDomain','$tax')");
...
-->
	...
	<form name="authorizeFrm" id="authorizeFrm" action="./process-credit-card.php" method="post">
   	<?php
		...
		<input type="hidden" name="x_relay_url"             value="./order_ok.php?tradecode=<?=$tradecode?>&p=paypal">
...
<input type="hidden" name="image_url" value="./images/ebhahair.jpg">
<input type="hidden" name="first_name" value="<?=$temp_row['name1']?>">
<input type="hidden" name="last_name" value="<?=$temp_row['name2']?>">
<input type="hidden" name="return" value="./order_ok.php?tradecode=<?=$tradecode?>&p=paypal">
<input type="hidden" name="cancel_return" value="./cart.php">
        ...
        <?
         ...
         <script type="text/javascript">
			 window.location = "./order_ok.php?tradecode=<?=$tradecode?>";
	         </script>	
		<? }else{
