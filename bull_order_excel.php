...
$result = mysql_query("SELECT `product_code`, `user_id`, `supplier_code`, `category`, `subcategory`, `sub_subcategory`, `product_name`,  `wholesale_price`, `min_quantity` FROM `product");
